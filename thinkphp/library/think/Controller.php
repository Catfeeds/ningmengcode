...
class Controller
{
    ...
    public function __construct(Request $request = null)
    {
        ...
        if(!empty($header['lang'])){
            if( $header['lang']== 'en-us'){
                $obj = new Lang;
                $obj->load(APP_PATH.'lang/'.'en-us.php');
            }
        }else{
            $obj = new Lang;
            $obj->load(APP_PATH.'lang/'.'zh-cn.php');
        }
        // 控制器初始化
        $this->_initialize();
...
//        $domainobj = new Domaincontrol;
//        $flag = $domainobj->runCheck();
//        $flag = true;
////         var_dump($flag);exit();
//        if(!$flag){
//            if( $domainobj->checkURI() ){
//                $this->ajaxReturn(return_format(['url'=>config('param.server_url')],301));
//                exit();
//            }else{
//                header('Location: '.config('param.server_url'));
//                exit();
//            }
//        }elseif( $flag===true ){// 放行
//
//        }else{
//            if( $domainobj->checkURI() ){
//                $this->ajaxReturn( return_format([ 'url' => $flag ],301) );
//                exit();
//            }else{
