...
use app\appstudent\business\AppMyOrderManage;
use app\appstudent\business\OfficalAppMyOrderManage;
use think\Session;
class Myorder extends Authorize
{
    ...
    public function gotoPay()
    {
        ...
        /*  $studentid = 1;
          ...
          $classtype = '2';
          $gradename = '班级名称';*/
        $res = $orderobj->gotoPay($studentid,$ordernum,$paytype,$source=1);
        $this->ajaxReturn($res);
     ...
     * @return   array();
     * URL:/appstudent/Myorder/getUnpaidOrder
     */
    public function getUnpaidOrder(){
        ...
        if($organid == 1){
            $orderobj = new OfficalAppMyOrderManage;
        }else{
            $orderobj = new AppMyOrderManage;
        }
