...
class Mycourse extends Authorize
{
     ...
     * @return   array();
     * URL:/microsite/Mycourse/getLessionsList
     */
    public function getLessionsList()
    {
        ...
        $studentid = $this->userid;
        $currobj = new MicroMyCourseManage;
    ...
    public function studentLessonsList(){
        ...
        $pagenum = $this->request->param('pagenum');
        $limit = $this->request->param('limit');
        $organobj = new MicroMyCourseManage;
     ...
     * @return   [type]                   [description]
     * URL:microsite/Mycourse/getLessonsPlayback
     */
     ...
     * @param    [string]           date  必填日期 eg: 2018-04-06
     * @return   [type]                   [description]
     * URL:microsite/Mycourse/intoClassroom
     */
     ...
     * @return   array()
     * URL:microsite/Mycourse/gotoComment
     */
     ...
     * @param    [string]           date  必填日期 eg: 2018-04-06
     * @return   [type]                   [description]
     * URL:microsite/Mycourse/viewLessonsDetails
     */
