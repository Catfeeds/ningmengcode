...
//class Student extends Controller
{
    ...
    public function getUserList()
    {
        ...
        $limit= config('param.pagesize')['teacher_stu_list'];
        $manageobj = new StudentManage;
        //获取教师列表信息,默认分页为5条
        $userlist = $manageobj->getUserList($data['mobil'],$data['nickname'],$data['pagenum'],$teacherid,$limit);
    ...
    */
    public function getUserinfo(){
        ...
        $manageobj = new StudentManage;
        //获取学生信息
        $userinfo  = $manageobj->getUserDetail($studentid,$pagenum,20) ;
    ...
    public function addUser(){
        ...
        $manageobj = new StudentManage;
        //获取教师列表信息,默认分页为5条
        $userlist  = $manageobj->addStudentInfo($data,$teacherid);
        $this->ajaxReturn($userlist) ;
