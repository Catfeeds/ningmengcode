...
require_once("alibatchtrans/lib/alipay_core.function.php");
require_once("alibatchtrans/lib/alipay_md5.function.php");
require_once("alibatchtrans/alipay.config.php");
class AliBatchTransNotify{
	...
	function getResponse($notify_id) {
		...
		$responseTxt = curl_get($veryfy_url, $options = array());
		return $responseTxt;
	}
}
